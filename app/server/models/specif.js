...
class partie {
  ...
  */
  ...
  lancerPartie() {
    ...
    // Vérifier s'il y a assez de joueurs pour démarrer la partie
    if (this.#players.length < 2) {
      console.log("Il n'y a pas assez de joueurs pour démarrer la partie.");
      return;
    }

    // mettre à zéro l'historique des mises
    this.#betHistory = [];

    // je melange les joueurs 
