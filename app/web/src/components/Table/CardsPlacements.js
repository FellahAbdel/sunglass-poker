  ...
  return (
    <div className={`container-cards ${disappear ? 'disappear' : ""}`}>
          ...
          <div className="container-tableCards">
            ...
            <Card card={["2","C"]} styleClass={`tableCard`} flippedStyle={"dealingFlop0"} flippingCard={dealingFlop[0]}/>
            <Card card={["3","C"]} styleClass={"tableCard"} flippedStyle={"dealingFlop1"} flippingCard={dealingFlop[0]}/>
            <Card card={["4","C"]} styleClass={"tableCard"} flippedStyle={"dealingFlop2"} flippingCard={dealingFlop[0]}/>
            <Card card={["5","C"]} styleClass={"tableCard"} flippedStyle={"dealingFlop3"} flippingCard={dealingFlop[1]}/>
            <Card card={["6","C"]} styleClass={"tableCard"} flippedStyle={"dealingFlop4"} flippingCard={dealingFlop[2]}/>
          </div>  
