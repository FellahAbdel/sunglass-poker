...
const PlayersPots = ({testOnClick1,testOnClick2,testOnClick3}) => {
  ...
  return (
    <div className="container-playerPots">
        ...
        <div className="playerPot0" onClick={testOnClick1}>1000 SC</div>
        <div className="playerPot1" onClick={testOnClick2}>1000 SC</div>
        <div className="playerPot2" onClick={testOnClick3}>1000 SC</div>
